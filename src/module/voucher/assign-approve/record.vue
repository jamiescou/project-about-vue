          ...
          <el-form :inline="true" :model="searchData" class="stand-form " style="margin-top:10px" label-width="100px">
              <fieldset>
                ...
                <el-form-item label="指定供应商">
                  <el-input v-model="searchData.companyQstr" placeholder="请输入指定供应商"></el-input>
                </el-form-item>
                ...
                <el-form-item label="审批状态" class="amount-range last-item">
...
export default merge({
  ...
  methods: {
    ...
    getGrid () {
      ...
      supplierVoucherService.getTransferApprovalRecord.remote(params, (result) => {
